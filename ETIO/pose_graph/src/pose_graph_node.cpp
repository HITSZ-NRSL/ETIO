...
int main(int argc, char **argv)
{
    ...
    if (LOOP_CLOSURE)
    {
        ...
        //m_camera = camodocal::CameraFactory::instance()->generateCameraFromYamlFile("/home/wangyu/catkin_ws/src/ETIO/config/euroc/euroc_config_fix_extrinsic.yaml");
        m_camera = camodocal::CameraFactory::instance()->generateCameraFromYamlFile("/home/wangyu/catkin_ws/src/ETIO/config/tau2.yaml");
        //m_camera = camodocal::CameraFactory::instance()->generateCameraFromYamlFile("/home/wangyu/catkin_ws/src/ETIO/config/thermal.yaml"); 
        //m_camera = camodocal::CameraFactory::instance()->generateCameraFromYamlFile("/home/wangyu/catkin_ws/src/ETIO/config/nrsl_realsense_d435i_config.yaml"); 
        //m_camera = camodocal::CameraFactory::instance()->generateCameraFromYamlFile("/home/wangyu/catkin_ws/src/ETIO/config/SJTU.yaml");
        ...
        // fout.close();
        fsSettings.release();
        std::ofstream foutC("/home/wangyu/catkin_ws/src/ETIO/Trajactory/tum_fast_ETIO_loop.txt", std::ios::out);
        foutC.close();
        std::ofstream foutC1("/home/wangyu/catkin_ws/src/ETIO/Trajactory/evo_fast_ETIO_loop.txt", std::ios::out);
        foutC1.close();     
    ...
    ros::Subscriber sub_imu_forward = n.subscribe("/ETIO/imu_propagate", 2000, imu_forward_callback);
    ros::Subscriber sub_vio = n.subscribe("/ETIO/odometry", 2000, vio_callback);
    ros::Subscriber sub_image = n.subscribe(IMAGE_TOPIC, 2000, image_callback);
    ros::Subscriber sub_pose = n.subscribe("/ETIO/keyframe_pose", 2000, pose_callback);
    ros::Subscriber sub_extrinsic = n.subscribe("/ETIO/extrinsic", 2000, extrinsic_callback);
    ros::Subscriber sub_point = n.subscribe("/ETIO/keyframe_point", 2000, point_callback);
    ros::Subscriber sub_relo_relative_pose = n.subscribe("/ETIO/relo_relative_pose", 2000, relo_relative_pose_callback);
