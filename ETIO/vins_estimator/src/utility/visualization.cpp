                ...
                Eigen::Matrix3d loop_correct_r)
{
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR)
    {
        ...
        ofstream foutC("/home/wangyu/infra_ws/slam_ws/src/ETIO/Trajactory/tum_epl.txt", ios::app);
        ...
        ofstream foutC1("/home/wangyu/infra_ws/slam_ws/src/ETIO/Trajactory/evo_epl.txt", ios::app);
