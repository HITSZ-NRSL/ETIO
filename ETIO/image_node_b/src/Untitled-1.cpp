...
int main(int argc, char **argv) {
  ...
  m_camera = camodocal::CameraFactory::instance()->generateCameraFromYamlFile("/home/wangyu/infra_ws/slam_ws/src/ETIO/config/tau2.yaml");
  ...
  message_filters::Subscriber<sensor_msgs::Image> image_sub(nh, "/image_raw", 1000);
